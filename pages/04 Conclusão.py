...
st.markdown('''- <b><font color='blue'>Desempenho Acadêmico (PV):</b></font> Para os indicadores de desempenho o <b>engajamento (IEG)</b> dos alunos tem um ótimo retorno, porém os outros índices chamam atenção para realizar um trabalho de acompanhamento, o <b>IAN</b> que mede questões voltadas a nutrição e bem estar dos alunos  ''', unsafe_allow_html=True)
st.markdown('''- <b><font color='blue'>Desempenho Psicossocial (PV):</b></font> ''', unsafe_allow_html=True)
st.markdown('''- <b><font color='blue'>Desempenho Psicopedagógica (PV):</b></font> ''', unsafe_allow_html=True)
